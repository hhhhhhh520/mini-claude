...
def create_alert_manager() -> "AlertManager":
    ...
    if settings.alert_enabled:
        instance.add_rule(HighFailureRateRule(threshold=settings.alert_failure_rate_threshold))
        instance.add_rule(HighLatencyRule(threshold=settings.alert_latency_threshold_seconds))
        instance.add_rule(TokenBudgetRule(threshold=settings.alert_token_budget_threshold))
        ...
        if settings.alert_webhook_url:
            instance.add_handler(WebhookHandler(webhook_url=settings.alert_webhook_url))
